...
if [ $COMMAND = init ];  then
	...
	if ! [ -f "./docker_done" ]; then
		...
		docker-compose run --rm stack is-db create-oauth-client --id console --name "Console" --owner admin --secret console --redirect-uri 'https://localhost:8885/console/oauth/callback'  --redirect-uri 'http://localhost:1885/console/oauth/callback' --redirect-uri '/console/oauth/callback'
		touch docker_done
	else
	...
	--redirect-uris "localhost:8010/login_callback" --secret="supasecret" --grants GRANT_AUTHORIZATION_CODE,GRANT_REFRESH_TOKEN \
	#--rights RIGHT_APPLICATION_ALL,RIGHT_APPLICATION_INFO,RIGHT_ORGANIZATION_APPLICATIONS_LIST,RIGHT_USER_APPLICATIONS_LIST \
	--rights RIGHT_USER_INFO,RIGHT_USER_APPLICATIONS_LIST,RIGHT_USER_GATEWAYS_LIST,RIGHT_APPLICATION_INFO,RIGHT_APPLICATION_DEVICES_READ,RIGHT_GATEWAY_INFO,RIGHT_GATEWAY_STATUS_READ,RIGHT_GATEWAY_LOCATION_READ \
	...
	# Required to bypass password validation
	ttn-lw-cli --ca ./certs/cert.pem user set uid-allan --state=STATE_APPROVED 
	ttn-lw-cli --ca ./certs/cert.pem user set uid-belinda --state=STATE_APPROVED
	ttn-lw-cli --ca ./certs/cert.pem user set uid-charlie --state=STATE_APPROVED
	ttn-lw-cli --ca ./certs/cert.pem user set uid-diane --state=STATE_APPROVED
	ttn-lw-cli --ca ./certs/cert.pem user set uid-edgar --state=STATE_APPROVED
	ttn-lw-cli --ca ./certs/cert.pem user set uid-freddie --state=STATE_APPROVED
	ttn-lw-cli --ca ./certs/cert.pem user set uid-giselle --state=STATE_APPROVED
	ttn-lw-cli --ca ./certs/cert.pem user set uid-howard --state=STATE_APPROVED
	ttn-lw-cli --ca ./certs/cert.pem user set uid-ivan --state=STATE_APPROVED
	...
	ttn-lw-cli --ca ./certs/cert.pem device create --application-id app-allan-1 --device-id dev-allan-1 --description "Allan device 1 description" --name "Allan device 1" --dev-eui 0111223344556601 --join-eui 8000000000010001 --lorawan-version 1.0.2 --lorawan-phy-version 1.0.2-b --frequency-plan-id EU_863_870
	ttn-lw-cli --ca ./certs/cert.pem device create --application-id app-allan-1 --device-id dev-allan-2 --description "Allan device 2 description" --name "Allan device 2" --dev-eui 0111223344556602 --join-eui 8000000000010002 --lorawan-version 1.0.2 --lorawan-phy-version 1.0.2-b --frequency-plan-id EU_863_870
	ttn-lw-cli --ca ./certs/cert.pem application create --application-id app-allan-2 --name "Allan Application 2" --user-id uid-allan
	ttn-lw-cli --ca ./certs/cert.pem device create --application-id app-allan-2 --device-id dev-allan-3 --description "Allan device 3 description" --name "Allan device 3" --dev-eui 0111223344556603 --join-eui 8000000000010003 --lorawan-version 1.0.2 --lorawan-phy-version 1.0.2-b --frequency-plan-id EU_863_870
	ttn-lw-cli --ca ./certs/cert.pem device create --application-id app-allan-2 --device-id dev-allan-4 --description "Allan device 4 description" --name "Allan device 4" --dev-eui 0111223344556604 --join-eui 8000000000010004 --lorawan-version 1.0.2 --lorawan-phy-version 1.0.2-b --frequency-plan-id EU_863_870
	ttn-lw-cli --ca ./certs/cert.pem device create --application-id app-allan-2 --device-id dev-allan-5 --description "Allan device 5 description" --name "Allan device 5" --dev-eui 0111223344556605 --join-eui 8000000000010005 --lorawan-version 1.0.2 --lorawan-phy-version 1.0.2-b --frequency-plan-id EU_863_870
	ttn-lw-cli --ca ./certs/cert.pem application create --application-id app-allan-3 --name "Allan Application 3" --user-id uid-allan
	ttn-lw-cli --ca ./certs/cert.pem device create --application-id app-allan-3 --device-id dev-allan-6 --description "Allan device 6 description" --name "Allan device 6" --dev-eui 0111223344556606 --join-eui 8000000000010006 --lorawan-version 1.0.2 --lorawan-phy-version 1.0.2-b --frequency-plan-id EU_863_870
	ttn-lw-cli --ca ./certs/cert.pem device create --application-id app-allan-3 --device-id dev-allan-7 --description "Allan device 7 description" --name "Allan device 7" --dev-eui 0111223344556607 --join-eui 8000000000010007 --lorawan-version 1.0.2 --lorawan-phy-version 1.0.2-b --frequency-plan-id EU_863_870
	ttn-lw-cli --ca ./certs/cert.pem device create --application-id app-allan-3 --device-id dev-allan-8 --description "Allan device 8 description" --name "Allan device 8" --dev-eui 0111223344556608 --join-eui 8000000000010008 --lorawan-version 1.0.2 --lorawan-phy-version 1.0.2-b --frequency-plan-id EU_863_870
	ttn-lw-cli --ca ./certs/cert.pem device create --application-id app-allan-3 --device-id dev-allan-9 --description "Allan device 9 description" --name "Allan device 9" --dev-eui 0111223344556609 --join-eui 8000000000010009 --lorawan-version 1.0.2 --lorawan-phy-version 1.0.2-b --frequency-plan-id EU_863_870
	...
	do
		ttn-lw-cli --ca ./certs/cert.pem device create --application-id app-belinda-1 --device-id "dev-belinda-$i" --description "Belinda device $i description" --name "Belinda device $i" --dev-eui "02112233445566$i" --join-eui "80000000000200$i" --lorawan-version 1.0.2 --lorawan-phy-version 1.0.2-b --frequency-plan-id EU_863_870
	...
	do
		...
		ttn-lw-cli --ca ./certs/cert.pem device create --application-id "app-diane-$i" --device-id "dev-diane-$i" --description "Diane device $i description" --name "Diane device $i" --dev-eui "04112233445566$i" --join-eui "80000000000400$i" --lorawan-version 1.0.2 --lorawan-phy-version 1.0.2-b --frequency-plan-id EU_863_870
	...
	ttn-lw-cli --ca ./certs/cert.pem device create --application-id app-giselle-1 --device-id dev-giselle-1 --description "Giselle device 1 description" --name "Giselle device 9" --dev-eui 0711223344556601 --join-eui 8000000000070009 --lorawan-version 1.0.2 --lorawan-phy-version 1.0.2-b --frequency-plan-id EU_863_870

	ttn-lw-cli --ca ./certs/cert.pem device create --application-id app-giselle-1 --device-id dev-giselle-2 --description "Giselle device 2 description" --name "Giselle device 9" --dev-eui 0711223344556602 --join-eui 8000000000070009 --lorawan-version 1.0.2 --lorawan-phy-version 1.0.2-b --frequency-plan-id EU_863_870
